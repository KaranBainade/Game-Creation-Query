...
public class QuizGameDataAnalysisDAOImpl {
	
	private static final String SQL_QUERY_TO_INSERT_USERS_EASY_STEP_LESS_TIME_RECORD = "INSERT INTO QUIZ_GAME_User_List_TO_Take_Less_Time_Complete_EASY_STEP(userName,timeTaken) VALUES(?,?)";
	private static final String SQL_QUERY_TO_INSERT_USERS_MEDIUM_STEP_LESS_TIME_RECORD = "INSERT INTO QUIZ_GAME_User_List_TO_Take_Less_Time_Complete_MEDIUM_STEP(userName,timeTaken) VALUES(?,?)";
	private static final String SQL_QUERY_TO_INSERT_USERS_HARD_STEP_LESS_TIME_RECORD = "INSERT INTO QUIZ_GAME_User_List_TO_Take_Less_Time_Complete_HARD_STEP(userName,timeTaken) VALUES(?,?)";
	private static final String SQL_QUERY_TO_INSERT_USERS_EASY_STEP_MORE_TIME_RECORD = "INSERT INTO QUIZ_GAME_User_List_TO_Take_More_Time_Complete_EASY_STEP(userName,timeTaken) VALUES(?,?)";
	private static final String SQL_QUERY_TO_INSERT_USERS_MEDIUM_STEP_MORE_TIME_RECORD = "INSERT INTO QUIZ_GAME_User_List_TO_Take_More_Time_Complete_MEDIUM_STEP(userName,timeTaken) VALUES(?,?)";
	private static final String SQL_QUERY_TO_INSERT_USERS_HARD_STEP_MORE_TIME_RECORD = "INSERT INTO QUIZ_GAME_User_List_TO_Take_More_Time_Complete_HARD_STEP(userName,timeTaken) VALUES(?,?)";
