...
//            System.out.println("f train : " + f_train);
            ...
            breader = new BufferedReader(new FileReader(trainn));
            Instances train = new Instances(breader);
            train.setClassIndex(train.numAttributes() - 1);

            breader1 = new BufferedReader(new FileReader(testt));
            Instances test = new Instances(breader1);
            test.setClassIndex(test.numAttributes() - 1);

//            LibSVM clasifier = new LibSVM();
            weka.classifiers.functions.NaieveBayes clasifier = new weka.classifiers.functions.NaieveBayes();
...
//            System.out.println("accuracy: " + eval.correct());
