...
public class BarGraph_time extends javax.swing.JFrame {

    public BarGraph_time(long[] ProSys) {
        setTitle("Time Graph");
...
//        FrmRatingBased.MAEGraph.setVisible(true);
    ...
    private CategoryDataset createDataset(/*double[] Exsys,*/long[] ProSys) {
...
//        dataset.addValue(80, "ExC_1", "");
    ...
    private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        final JFreeChart chart = ChartFactory.createBarChart(
                ...
                "Time (nano seconds)", // range axis label
                dataset, // data
...
//        long[] prsys = {70, 50};
//
//        BarGraph_time cg = new BarGraph_time(prsys);
//        cg.pack();
//        cg.setVisible(true);
//
//    }
