 ...
 */
package com.gamecreation.computations;
...
public class KShingling {
     ...
     * into a set of n-grams, which can be used to measure the similarity
     * between two strings or documents.
     *     
     */
    public KShingling() {
        k = 5;
     ...
     * Jaccard index, etc. E.g. if s = ABCAB and k =2 The KShingling object will
     * store the dictionary of n-grams: {AB BC CA} and the profile will be [2 1
     * 1]
     *
     * Attention: the space requirement of a single profile can be as large as
     * 20^k x 4Bytes (sizeof(int)) Computation cost is O(n)
     *
     * @param s
     * @return the profile of this string as an array of integers
     */
    public int[] getArrayProfile(String s) {
    ...
    /**
     * Compute and returns the profile of string s The profiles of different
     * strings can be used to compute cosine similarity or qgram distance.
     *
     * @param s
     ...
     *
     * @return the total number of different n-grams found by this k-shingling
     * instance
     */
