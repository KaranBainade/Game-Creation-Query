...
public class SparseIntegerVector implements Serializable {
    ...
    /**
     * Computes and return the Jaccard index with other SparseVector. |A inter
     * B| / |A union B| It is actually computed as |A inter B| / (|A| +|B| - | A
     * inter B|) using a single loop over A and B
     *
     * @param other
     * @return
     */
    ...
    /**
     * Compute and return the qgram similarity with other vector. Sum(|a_i -
     * b_i|)
     *
     * @param other
     * @return
